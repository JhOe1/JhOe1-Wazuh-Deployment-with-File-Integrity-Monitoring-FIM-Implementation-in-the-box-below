...
## Wazuh Deployment with File Integrity Monitoring (FIM) Implementation
In this I project i will be installing wazuh on my Ubuntu desktop, focusing on the implementation of the File Integrity Monitoring (FIM) module. FIM is crucial in detecting unauthorized modifications to critical files, helping to prevent malicious activities. Everthing was done in my virutual lab using VMware.

The steps include:
- Installing Wazuh using Install guide in the wazuh website.
...
Once the assistant finishes the installation, it  showed the access credentials and a message that confirms that the installation was successful.
